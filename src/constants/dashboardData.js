...
export const HEATMAP_SECTORS = [
  { id:'semiconductor', name:'반도체·IT',   stocks:'삼성전자, SK하이닉스', themeColor:'#1d4ed8', inds_cd:'013',
    repCodes:['005930','000660','042700','009150','066970'] },  // 전기전자
  { id:'battery',       name:'2차전지',      stocks:'LG에너지솔루션, 삼성SDI', themeColor:'#2563eb', inds_cd:'013',
    repCodes:['373220','006400','003670','247540','086520'] },  // 전기전자 (반도체와 동일 업종)
  { id:'auto',          name:'자동차',       stocks:'현대차, 기아', themeColor:'#3b82f6', inds_cd:'015',
    repCodes:['005380','000270','012330','011210','064350'] },  // 운수장비
  { id:'bio',           name:'바이오·제약',  stocks:'삼성바이오, 셀트리온', themeColor:'#7c3aed', inds_cd:'009',
    repCodes:['207940','068270','000100','128940','326030'] },  // 의약품
  { id:'game',          name:'게임·엔터',   stocks:'HYBE, 엔씨소프트', themeColor:'#8b5cf6', inds_cd:'024',
    repCodes:['259960','036570','251270','352820','035420'] },  // 서비스업
  { id:'finance',       name:'금융·보험',   stocks:'KB금융, 신한지주', themeColor:'#0891b2', inds_cd:'020',
    repCodes:['105560','055550','086790','316140','138040'] },  // 금융업
  { id:'energy',        name:'에너지',       stocks:'한국전력, 한국가스공사', themeColor:'#16a34a', inds_cd:'017',
    repCodes:['015760','036460','034020','117000','267260'] },  // 전기가스업
  { id:'chemical',      name:'화학·소재',   stocks:'LG화학, 롯데케미칼', themeColor:'#15803d', inds_cd:'008',
    repCodes:['051910','011170','009830','010950','285130'] },  // 화학
  { id:'telecom',       name:'통신',         stocks:'SKT, KT', themeColor:'#64748b', inds_cd:'024',
    repCodes:['017670','030200','032640','035420','035720'] },  // 서비스업 (통신 별도코드 없음)
  { id:'retail',        name:'유통·소비재', stocks:'이마트, 롯데쇼핑', themeColor:'#94a3b8', inds_cd:'016',
    repCodes:['139480','023530','004170','069960','005440'] },  // 유통업
  { id:'construct',     name:'건설·부동산', stocks:'현대건설, DL이앤씨', themeColor:'#0369a1', inds_cd:'018',
    repCodes:['000720','006360','047040','375500','028260'] },  // 건설업
  { id:'shipyard',      name:'조선·기계',   stocks:'HD한국조선해양, 두산에너빌', themeColor:'#0e7490', inds_cd:'012',
    repCodes:['009540','010140','042660','329180','034020'] },  // 기계
]
...
// ── 2026 핫 테마 ─────────────────────────────────────
// catalyst: 지금 주목받는 이유 / thesis: 투자 논리 / risk: 핵심 리스크
export const HOT_THEMES = [
  {
    ...
    catalyst:['GPT-4o·Gemini 기반 에이전트 서비스 상용화','기업용 AI 자동화 수요 급증','국내 빅테크 에이전트 플랫폼 경쟁'],
    thesis:'AI가 단순 검색을 넘어 업무 전체를 자동화하는 에이전트 시대 진입. 플랫폼 선점 기업이 장기 수혜.',
    risk:'글로벌 빅테크와의 경쟁 심화, 수익화 모델 불확실',
  },
  {
    ...
    catalyst:['인건비 급등으로 제조업 자동화 필요성 증대','테슬라 옵티머스 상용화 기대감','정부 스마트 제조 정책 지원'],
    thesis:'제조·물류 현장 자동화 수요가 구조적으로 증가. 국내 협동로봇 기업의 가격 경쟁력이 글로벌 시장 진입 기회.',
    risk:'중국 저가 로봇 경쟁, 기술 상용화 지연',
  },
  {
    ...
    catalyst:['미국 AI 데이터센터 전력난으로 원전 수요 급증','유럽 탈원전 정책 폐기 흐름','한국형 APR1400 수출 협상 진행'],
    thesis:'AI 전력 수요가 원전 르네상스를 이끄는 구조. 한국은 건설 경험·가격 경쟁력 보유로 수주 유리.',
    risk:'규제 승인 지연, 건설 비용 초과, 여론 반전 리스크',
  },
  {
    id:'defense', label:'K-방산 수출', icon:'🛡️', color:'#dc2626',
    desc:'유럽·중동·동남아 방산 수출 확대',
    tags:['한화에어로','LIG넥스원','현대로템'],
    repCodes:['012450','079550','064350','047810','272210'],
    catalyst:['러시아-우크라이나 전쟁 이후 NATO 회원국 국방비 증가','K-방산 납기·가격 경쟁력 인정','폴란드·루마니아 대형 계약 체결'],
    thesis:'글로벌 지정학 리스크 장기화로 방산 수요 구조적 증가. 한국 방산의 글로벌 점유율 확대 사이클.',
    risk:'외교 관계 변화, 환율 리스크, 경쟁국 가격 인하',
  },
  {
    ...
    catalyst:['AI 데이터센터 전력 소비 폭발적 증가','미국·유럽 전력망 노후화 교체 수요','국내 재생에너지 연계 송전망 투자'],
    thesis:'전기화·디지털화 동시 진행으로 전력 인프라 투자 사이클 장기화. 변압기·개폐기 등 수주 잔고 급증.',
    risk:'원자재(구리·실리콘) 가격 변동, 프로젝트 지연',
  },
  {
    ...
    catalyst:['ADC 글로벌 기술수출 계약 잇달아 체결','빅파마의 ADC 플랫폼 기업 M&A 가속','임상 성공률 향상으로 투자자 신뢰 회복'],
    thesis:'차세대 항암제 ADC 글로벌 시장 성장. 국내 기업의 원천기술로 기술수출 계약 지속 기대.',
    risk:'임상 실패 리스크, 빅파마 내재화 전환 가능성',
  },
  {
    id:'lng', label:'LNG 조선', icon:'🚢', color:'#0891b2',
    desc:'LNG 운반선 수주 호황 지속',
    tags:['HD한국조선','삼성중공업','한화오션'],
    repCodes:['009540','010140','042660','329180','000720'],
    catalyst:['글로벌 LNG 수요 증가로 운반선 발주 급증','HD한국조선해양 수주잔고 역대 최대','中 조선사 품질·납기 리스크로 한국 선호'],
    thesis:'에너지 전환 과도기에 LNG 수요 지속. 한국 조선 3사가 전 세계 고부가가치 LNG선 독점.',
    risk:'수주 사이클 둔화, 철강·후판 원자재 가격 상승',
  },
  {
    id:'supply', label:'공급망 재편', icon:'🌏', color:'#64748b',
    desc:'미중 디커플링·제조 리쇼어링 수혜',
    tags:['삼성전자','SK하이닉스','포스코'],
    repCodes:['005930','000660','005490','003670','051910'],
    catalyst:['미국 반도체·배터리 공급망 자국화 정책','IRA·CHIPS법 수혜 국내 기업 확대','중국 의존도 낮추는 글로벌 공급망 재편'],
    thesis:'미중 갈등이 한국 기업의 반사이익으로 연결. 첨단 소부장 국산화 및 대미 수출 수혜.',
    risk:'미국 정책 불확실성, 중국 보복 관세 리스크',
  },
]
